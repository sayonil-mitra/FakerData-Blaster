...
// import { generateFullDistrictData } from "./controllers.js";
...
//   const purgeId = await addPurgeId(purgeNames.GUJARATDATA);
//   const data = generateFullDistrictData(
//     purgeId,
//     firstLevel,
...
//   try {
//     const purgeId = await getFirstPurgeId(purgeNames.GUJARATDATA);
...
router.post("/", async (req, res) => {
  try {
    ...
    let data = generateFullDistrictData(
      totalCount,
      incrementEachLevel,
      purgeId
    );
    ...
    res.status(200).json({ message: "Success: Gujarat synthetic data generated!",data:data});
  } catch (error) {
