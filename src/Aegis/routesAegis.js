...
// import { generateDataForAegis } from "./controllerAegis.js";
...
//     let data=generateDataForAegis(totalCount, incrementEachLevel, purgeId);
...
const ingestHandler = async (firstLevel, incrementOnEachLevel) => {
	const purgeId = await addPurgeId(purgeNames.AEGIS);
	const data = generateDataForAegis(purgeId, firstLevel, incrementOnEachLevel);
