...
// import { generateFullContentProviderData } from "./controller.js";
...
//   const purgeId = await addPurgeId(purgeNames.CONTENTPROVIDER);
//   const data = generateFullContentProviderData(
//     purgeId,
//     firstLevel,
...
//   try {
//     const purgeId = await getFirstPurgeId(purgeNames.CONTENTPROVIDER);
...
import { Router } from "express";
import { generateFullStudentData } from "./controller.js";
...
router.post("/", async (req, res) => {
  try {
    ...
    let data = generateFullStudentData(totalCount, incrementEachLevel, purgeId);
